...
export default {
    ...
    methods: {
        ...
        submit() {
            if (this.isEdit) {
                this.form.put(route('admin.amenities.update', {
                    amenity: this.form.id
                }), {
                    onFinish: () => {
                        // location.reload();
                    },
                ...
                this.form.post(route('admin.amenities.store'), {
                    onFinish: () => {
                        // location.reload();
                    },
                });
        ...
        deleteAmenity(amenity) {
            ...
            if (confirm('Are you sure you want to delete this room type?')) {
                this.form.delete(route('admin.amenities.delete', {
                    amenity: amenity.id
                }));
            }
            ...
            <div class="row">
                <div class="col-12 mb-4 mb-sm-5">
                    <div class="d-sm-flex justify-content-between align-items-center">
                        <h1 class="h3 mb-3 mb-sm-0">Amenities</h1>
                        <div class="d-grid"><a href="#" data-bs-toggle="modal" data-bs-target="#inquiryForm"
                                class="btn btn-primary mb-0"><i class="bi bi-filetype-pdf me-2"></i>Create Amenity</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div v-for="amenity in amenities"
                        ...
                        <div class="col">
                            ...
                            <h6 class="mb-0 fw-normal">{{ amenity.name }}</h6>
                        </div>
                        <div class="col">
                            <small class="d-block d-lg-none">Description:</small>
                            <h6 class="mb-0 fw-normal">{{ amenity.description }}</h6>
                        </div>

                        <!-- Data item -->
                        <div class="col">
                            <small class="d-block d-lg-none">Created At:</small>
                            <h6 class="mb-0 fw-normal">{{ amenity.created_at }}</h6>
                        </div>
                        ...
                        <div class="col">
                            <a href="#" class="btn btn-sm btn-light mb-0" data-bs-toggle="modal"
                                data-bs-target="#inquiryForm" @click="edit(amenity)">Edit</a>
                            <a href="#" class="btn btn-sm btn-danger mb-0" @click="deleteAmenity(amenity)">Delete</a>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="inquiryFormlabel">{{ isEdit ? `Edit Amenity ${form.name}`
                            : "Create New Amenity" }}</h5>
