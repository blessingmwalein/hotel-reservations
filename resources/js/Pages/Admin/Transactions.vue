                    ...
                    <div class="col-lg-6">
                        <div class="card shadow p-3">
                            <div class="row g-4">
                                <!-- Card img -->
                                <div class="col-md-3">
                                    <img src="/assets/images/category/hotel/4by3/10.jpg" class="rounded-2"
                                        alt="Card image" />
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="card-body position-relative d-flex flex-column p-0 h-100">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end min-w-auto shadow"
                                                ...
                                                <li>
                                                    <a class="dropdown-item small" href="#"><i
                                                            class="bi bi-info-circle me-2"></i>Report</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item small" href="#"><i
                                                            class="bi bi-slash-circle me-2"></i>Disable</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <small><i class="bi bi-geo-alt me-2"></i>31J W Spark Street,
                                            California - 24578</small>
                    ...
                    <div class="col-lg-6">
                        <div class="card shadow p-3">
                            <div class="row g-4">
                                <!-- Card img -->
                                <div class="col-md-3">
                                    <img src="/assets/images/category/hotel/4by3/08.jpg" class="rounded-2"
                                        alt="Card image" />
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="card-body position-relative d-flex flex-column p-0 h-100">
                                        ...
                                        <small><i class="bi bi-geo-alt me-2"></i>258 W jimmy Street,
                                            New york - 24578</small>
                    ...
                    <div class="col-lg-6">
                        <div class="card shadow p-3">
                            <div class="row g-4">
                                <!-- Card img -->
                                <div class="col-md-3">
                                    <img src="/assets/images/category/hotel/4by3/09.jpg" class="rounded-2"
                                        alt="Card image" />
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card shadow p-3">
                            <div class="row g-4">
                                <!-- Card img -->
                                <div class="col-md-3">
                                    <img src="/assets/images/category/hotel/4by3/07.jpg" class="rounded-2"
                                        alt="Card image" />
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="card-body position-relative d-flex flex-column p-0 h-100">
                                        ...
                                        <small><i class="bi bi-geo-alt me-2"></i>589 J Wall Street,
                                            London - 24578</small>
                        ...
                        <div class="card shadow h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex gap-4 mb-3">
                                    <h6>
                                        <span class="fw-light"><i class="bi bi-square-fill text-primary"></i>
                                            Check-in:</span>
                                        475 Guests
                                    </h6>
                                    <h6>
                                        <span class="fw-light"><i class="bi bi-square-fill text-info"></i>
                                            Check-out:</span>
                                        157 Guests
                                    </h6>
                                </div>
                                    ...
                                    <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                                        ...
                                        <div class="ms-sm-3 mt-2 mt-sm-0">
                                            ...
                                            <ul class="nav nav-divider small">
                                                ...
                                                <li class="nav-item">
                                                    <span class="text-danger">Booking cancel</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
